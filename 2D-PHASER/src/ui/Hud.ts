/**
 * Thin wrapper around the DOM HUD: the live score, the next-block preview
 * swatch, and a game-over overlay. Keeping DOM access in one place keeps the
 * scene focused on gameplay. Mirrors the 3D build's `Hud`.
 */
export class Hud {
